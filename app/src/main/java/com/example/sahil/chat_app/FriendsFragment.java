...
//
    ...
    public void onStart() {
       ...
       //                 Boolean userOnline = dataSnapshot.child("Online").getValue().;
                        ...
                        viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                CharSequence optinos[] = new CharSequence[]{"Open Profile","Send Messasge"};

                               final AlertDialog.Builder builder = new AlertDialog.Builder(getContext());
                                builder.setTitle("Select Options");
                                builder.setItems(optinos, new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialogInterface, int i) {

                                        if (i == 0) {
                                            Intent k = new Intent(getContext(), ProfileActivity.class);
                                            k.putExtra("user_id", list_user_id);
                                            startActivity(k);
                                        }
                                        if (i == 1){
                                            Intent k = new Intent(getContext(), MessageActivity.class);
                                            k.putExtra("user_id", list_user_id);
